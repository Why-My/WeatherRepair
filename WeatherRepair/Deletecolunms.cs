...
{
    public partial class Deletecolunms : Form
    {
        string ResourePath;
        FileInfo[] WdataFile;
        string MDcols;
        string GDcols;
        public Deletecolunms()
        {
            InitializeComponent();
        }
        public Deletecolunms(string ResourePath2)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (a && b)
            {
                ...
                ProgressBar bar = new ProgressBar(WdataFile, ResourePath, MDcols, GDcols,2);
                bar.ShowDialog();
            }
        }
